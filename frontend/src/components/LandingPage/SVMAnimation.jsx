        ...
        <>
            ...
            <div className={`w-full flex-col absolute justify-center text-green2 pb-64 ${animationState !== 'finish' && 'invisible'}`}>
                <div className='text-6xl h-14 mb-10'>
                    ...
                    to
                    <span id='word2' className='mx-8'>Happy</span>
                </div>
                <div className='animate-pulse cursor-pointer'>
                    {/* scrolling broke */}
                    <Icon w={20} h={20} color='vividSkyBlue' as={FaPlay} onClick={() => contentRef.current.scrollIntoView({ behavior: 'smooth', block: 'start' })} />
                </div>
            </div>
        </>
    );
